...
namespace Gearset.Components.InspectorWPF {
    ...
    public sealed class TypeToSpinnerModeConverter : IValueConverter {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture) {
            var code = Type.GetTypeCode((Type)value);
            switch (code) {
                case TypeCode.Byte:
                    return NumericSpinnerMode.Byte;
                case TypeCode.Char:
                    return NumericSpinnerMode.Char;
                case TypeCode.Decimal:
                    return NumericSpinnerMode.Decimal;
                case TypeCode.Int16:
                    return NumericSpinnerMode.Short;
                case TypeCode.Int32:
                    return NumericSpinnerMode.Int;
                case TypeCode.Int64:
                    return NumericSpinnerMode.Long;
                case TypeCode.SByte:
                    return NumericSpinnerMode.SByte;
                case TypeCode.UInt16:
                    return NumericSpinnerMode.UShort;
                case TypeCode.UInt32:
                    return NumericSpinnerMode.UInt;
                case TypeCode.UInt64:
                    return NumericSpinnerMode.ULong;
                case TypeCode.Single:
                    return NumericSpinnerMode.Float;
                case TypeCode.Double:
                    return NumericSpinnerMode.Double;
            }
            throw new InvalidCastException("Error while trying to convert a Type Object to a SpinnerMode");
        }

        public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture) {
            var mode = (NumericSpinnerMode)value;
            switch (mode) {
